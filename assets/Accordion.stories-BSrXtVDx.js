import{H as e,R as C,N as g}from"./iframe-Dxm6wkCs.js";import{i as v}from"./isValidReactNode-W_TwQkzW.js";import{c as a}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";const _="Accordion";var u=(n=>(n.ITEM="Accordion.Item",n))(u||{});const N="_root_1x5uq_5",b={root:N},y=[u.ITEM],l=n=>{const{children:r}=n,c=i=>v(y,i)?i:null;return e.jsx("div",{className:b.root,children:C.Children.map(r,c)})};l.displayName=_;l.__docgenInfo={description:`Accordion container. Renders a vertically stacked list of expandable sections.
