...
\`\`\``,methods:[],displayName:"Tabs",props:{defaultActiveIndex:{required:!1,tsType:{name:"number"},description:"Active tab index by default."},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(activeIndex: number) => void",signature:{arguments:[{type:{name:"number"},name:"activeIndex"}],return:{name:"void"}}},description:"On active tab change handler."},variant:{required:!1,tsType:{name:"ETabsVariant"},description:"Tabs variant."}}};const l=C;l.Tab=g;const{fn:K}=__STORYBOOK_MODULE_TEST__,Z={title:"Kit/Components/Tabs",component:l,subcomponents:{"Tabs.Tab":l.Tab},parameters:{layout:"padded"},argTypes:{variant:{control:{type:"radio"},options:Object.values(_),table:{defaultValue:{summary:"ETabsVariant.DEFAULT"}}}},tags:["autodocs"]},v={args:{onChange:K()},render:function(a){return n.jsxs(l,{...a,children:[n.jsx(l.Tab,{label:"Tab 1",children:"Tab 1 Content"}),n.jsx(l.Tab,{label:"Tab 2",children:"Tab 2 Content"}),n.jsx(l.Tab,{label:"Tab 3 Disabled",disabled:!0,children:"Tab 3 Content"}),n.jsx(l.Tab,{label:"Tab 4",children:"Tab 4 Content"})]})}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    onChange: fn()
  },
