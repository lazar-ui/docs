import{N as i,H as a}from"./iframe-16V6KrfE.js";import{c as C}from"./clsx-B-dksMZM.js";import{s as y}from"./Overlay-B8WTMqXI.js";import{$ as T,a as O}from"./useOverlayTriggerState-DTjciNg5.js";import{$}from"./useOverlayPosition-C7kY86Ux.js";const f=i.createContext(null),R=f.Provider,v=()=>{const e=i.useContext(f);if(!e)throw new Error("Sub-component must be used within a Popover");return e},c="Popover",_=4;var d=(e=>(e.TRIGGER=`${c}.Trigger`,e.CONTENT=`${c}.Content`,e))(d||{});const N="_content_1eljy_10",E="_noPadding_1eljy_32",g={content:N,noPadding:E},l=e=>{const{children:t,padding:r=!0}=e,{triggerRef:n,state:o,placement:p}=v(),s=i.useRef(null),{overlayProps:b,placement:h}=$({isOpen:o.isOpen,offset:_,overlayRef:s,placement:p,shouldFlip:!0,targetRef:n}),{overlayProps:x}=T({isDismissable:!0,isOpen:o.isOpen,onClose:o.close},s);return o.isOpen?a.jsx(y,{children:a.jsx("div",{className:C(g.content,!r&&g.noPadding),"data-placement":h,ref:s,...x,...b,children:t})}):null};l.displayName=d.CONTENT;l.__docgenInfo={description:`Popover content panel. Renders via portal with automatic positioning relative to the trigger.
