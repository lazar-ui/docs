import{H as e}from"./iframe-DN6kL_na.js";import{c as S}from"./clsx-B-dksMZM.js";import{g as y}from"./getVariantClassName-DghXpxq_.js";import"./preload-helper-PPVm8Dsz.js";import"./camelCase-B2JfezL4.js";const k="Switch",w="_root_qj3dm_24",C="_disabled_qj3dm_33",_="_input_qj3dm_39",j="_track_qj3dm_52",z="_thumb_qj3dm_64",v="_label_qj3dm_75",D="_sizeSm_qj3dm_102",q="_sizeMd_qj3dm_112",E="_sizeLg_qj3dm_122",t={root:w,disabled:C,input:_,track:j,thumb:z,label:v,sizeSm:D,sizeMd:q,sizeLg:E},a=s=>{const{children:p,checked:h,defaultChecked:u,disabled:m=!1,onChange:g,size:f="md",...x}=s,b=S(t.root,y("size",f,t),m&&t.disabled);return e.jsxs("label",{className:b,children:[e.jsx("input",{...x,checked:h,className:t.input,defaultChecked:u,disabled:m,onChange:g,role:"switch",type:"checkbox"}),e.jsx("span",{className:t.track,"aria-hidden":"true",children:e.jsx("span",{className:t.thumb})}),p&&e.jsx("span",{className:t.label,children:p})]})};a.displayName=k;a.__docgenInfo={description:`Switch component. Renders a toggle switch for on/off settings.
