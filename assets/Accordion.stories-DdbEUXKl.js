import{N as m,H as e,R as T}from"./iframe-Cjz0EO4m.js";import{i as N}from"./isValidReactNode-Dp74o5CD.js";import{c as O}from"./clsx-B-dksMZM.js";import{I as R}from"./Icon-D96ntG05.js";import"./preload-helper-PPVm8Dsz.js";const _=m.createContext(null),M=()=>m.useContext(_),w="Accordion";var j=(t=>(t.ITEM="Accordion.Item",t))(j||{});const q="_root_grshw_5",z={root:q},E=[j.ITEM],C=t=>{const{children:g,defaultValue:p=null,onValueChange:s,value:r}=t,u=r!==void 0,[c,a]=m.useState(p);let i;u?i=r??null:i=c;const v=m.useCallback(o=>{let d;i===o?d=null:d=o,u||a(d),s?.(d)},[i,u,s]),x=o=>N(E,o)?o:null;return e.jsx(_.Provider,{value:{onItemToggle:v,openValue:i},children:e.jsx("div",{className:z.root,children:T.Children.map(g,x)})})};C.displayName=w;C.__docgenInfo={description:`Accordion container. Supports multi-select and single-select modes.
