...
}`,...p.parameters?.docs?.source},description:{story:"Render Typography with a custom HTML tag.\nThe `as` prop overrides the default tag inferred from the variant.",...p.parameters?.docs?.description}}};const Y=["Default","Headline","Body","Label","Colors","Truncate","CustomTag"];export{t as Body,n as Colors,p as CustomTag,d as Default,o as Headline,i as Label,l as Truncate,Y as __namedExportsOrder,U as default};
