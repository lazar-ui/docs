import{N as m,H as e,R as T}from"./iframe-jW71M8gU.js";import{i as N}from"./isValidReactNode-CfD2n9zO.js";import{c as O}from"./clsx-B-dksMZM.js";import{I as R}from"./Icon-BpITn-Ye.js";import"./preload-helper-PPVm8Dsz.js";const _=m.createContext(null),M=()=>m.useContext(_),w="Accordion";var j=(t=>(t.ITEM="Accordion.Item",t))(j||{});const q="_root_grshw_5",E={root:q},z=[j.ITEM],S=t=>{const{children:I,defaultValue:p=null,onValueChange:s,value:r}=t,u=r!==void 0,[c,a]=m.useState(p);let i;u?i=r??null:i=c;const v=m.useCallback(o=>{let d;i===o?d=null:d=o,u||a(d),s?.(d)},[i,u,s]),x=o=>N(z,o)?o:null;return e.jsx(_.Provider,{value:{onItemToggle:v,openValue:i},children:e.jsx("div",{className:E.root,children:T.Children.map(I,x)})})};S.displayName=w;S.__docgenInfo={description:`Accordion container. Supports multi-select and single-select modes.
    ...
    return <div style={{
      width: '800px'
        ...
        <Accordion>
          ...
          <Accordion.Item icon="lock" title="Security Protocols">
...
}`,...g.parameters?.docs?.source}}};const Y=["Default","SingleSelect","WithIcons","SingleItem"];export{h as Default,g as SingleItem,A as SingleSelect,f as WithIcons,Y as __namedExportsOrder,Z as default};
