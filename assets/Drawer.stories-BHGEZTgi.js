import{R as F,N as o,H as e}from"./iframe-Dxm6wkCs.js";import{B as p}from"./Button-hs5znv8t.js";import{i as V}from"./isValidReactNode-W_TwQkzW.js";import"./camelCase-Df9BNvgk.js";import{c as Y}from"./clsx-B-dksMZM.js";import{$ as U,a as W}from"./useModalOverlay-BmU_4AnS.js";import{s as K,i as G}from"./Overlay-BC7rFpTg.js";import{a as J}from"./useOverlayTriggerState-VuZPGsfj.js";import{g as Q}from"./getComponentSlots-CaMK2_yV.js";import{g as A}from"./getVariantClassName-Qnu0mv72.js";import{u as X}from"./useLocale-DlaTKHEV.js";import"./preload-helper-PPVm8Dsz.js";import"./index-PRTEUu8a.js";import"./index-DT_Pa5O3.js";var i=(t=>(t.ACTIONS="Drawer.Actions",t.CONTENT="Drawer.Content",t.HEADER="Drawer.Header",t))(i||{});const Z="_root_1m4yu_1",ee={root:Z},b=({children:t})=>{const a=F.Children.toArray(t),s=a.map((n,l)=>{if(!V("Button",n))return n;const c=n.props.variant,C=c??(l===0?"primary":"secondary");return o.cloneElement(n,{key:l,...c?{}:{variant:C}})});return a.length===0?null:e.jsx("div",{className:ee.root,children:s})};b.displayName=i.ACTIONS;b.__docgenInfo={description:"Wrapper for action buttons inside Drawer.\nAccepts only `<Button>` components as children.\nAuto-assigns variant based on position:\n- first child → `primary`\n- subsequent children → `secondary`\nunless the Button already has an explicit `variant` prop.",methods:[]};const ne="_root_jagsa_1",re={root:ne},_=t=>{const{children:a}=t;return e.jsx("div",{className:re.root,children:a})};_.displayName=i.CONTENT;_.__docgenInfo={description:`Drawer Content sub-component.
...
\`\`\``,methods:[]};const te="Drawer",ae=[i.ACTIONS,i.CONTENT,i.HEADER],B=o.createContext(null),se=()=>{const t=o.useContext(B);if(!t)throw new Error("Drawer sub-components must be used within a Drawer component.");return t},oe="_underlay_qcy0k_24",ie="_modal_qcy0k_32",le="_drawer_qcy0k_37",ce="_placementLeft_qcy0k_47",pe="_entered_qcy0k_53",de="_placementRight_qcy0k_56",me="_placementTop_qcy0k_65",ue="_placementBottom_qcy0k_74",he="_sizeSm_qcy0k_83",fe="_sizeMd_qcy0k_90",we="_sizeLg_qcy0k_97",De="_content_qcy0k_105",d={underlay:oe,modal:ie,drawer:le,placementLeft:ce,entered:pe,placementRight:de,placementTop:me,placementBottom:ue,sizeSm:he,sizeMd:fe,sizeLg:we,content:De},Ce=300,j=t=>{const{children:a,container:s,dismissable:n=!0,onOpenChange:l,open:c,placement:C="right",size:q="md"}=t,N=o.useRef(null),y=o.useRef(null),{dialogProps:E}=U(t,N),S=J({isOpen:c,onOpenChange:l}),{modalProps:$,underlayProps:z}=W({isDismissable:n,isKeyboardDismissDisabled:!1},S,y),[k,H]=o.useState(c||!1),[I,v]=o.useState(!1),g=o.useRef(k);o.useEffect(()=>{if(c){g.current=!0,H(!0);const x=requestAnimationFrame(()=>{requestAnimationFrame(()=>{v(!0)})});return()=>cancelAnimationFrame(x)}if(g.current){v(!1);const x=setTimeout(()=>{g.current=!1,H(!1)},Ce);return()=>clearTimeout(x)}},[c]);const{[i.ACTIONS]:L,[i.CONTENT]:R,[i.HEADER]:M}=o.useMemo(()=>Q(a,ae),[a]),P=Y(d.drawer,A("size",q,d),A("placement",C,d),{[d.entered]:I});return k?e.jsx(K,{portalContainer:s,children:e.jsx("div",{className:d.underlay,...z,children:e.jsx("div",{className:d.modal,...$,ref:y,children:e.jsx(G,{getContainer:()=>y.current,children:e.jsx(B.Provider,{value:{close:()=>S.close()},children:e.jsxs("div",{"aria-label":"Drawer","aria-modal":"true",className:P,role:"dialog",...E,ref:N,children:[M,R&&e.jsx("div",{className:d.content,children:R}),L]})})})})})}):null};j.displayName=te;j.__docgenInfo={description:`Drawer component.
...
}`,...D.parameters?.docs?.source}}};const ze=["Default","LeftPlacement","TopPlacement","Small","NonDismissable","WithActions"];export{m as Default,u as LeftPlacement,w as NonDismissable,f as Small,h as TopPlacement,D as WithActions,ze as __namedExportsOrder,$e as default};
