import{H as e,R as j}from"./iframe-DN6kL_na.js";import{c as w}from"./clsx-B-dksMZM.js";import{g as h}from"./getVariantClassName-DghXpxq_.js";import"./preload-helper-PPVm8Dsz.js";import"./camelCase-B2JfezL4.js";const _="Textarea",E="_root_jo37b_14",R="_invalid_jo37b_55",C="_sizeSm_jo37b_67",L="_sizeMd_jo37b_73",B="_sizeLg_jo37b_79",M="_resizeNone_jo37b_86",D="_resizeVertical_jo37b_90",V="_resizeBoth_jo37b_94",s={root:E,invalid:R,sizeSm:C,sizeMd:L,sizeLg:B,resizeNone:M,resizeVertical:D,resizeBoth:V},a=t=>{const{invalid:r=!1,resize:u="vertical",rows:x=3,size:v="md",onChange:g,onBlur:y,onFocus:z,...T}=t,f=w(s.root,h("size",v,s),h("resize",u,s),r&&s.invalid),b=S=>{g?.(S.target.value)};return e.jsx("textarea",{...T,className:f,onChange:b,onBlur:y,onFocus:z,rows:x})};a.displayName=_;a.__docgenInfo={description:`Textarea component. Renders a native \`<textarea>\` with size, resize, and state variants.
