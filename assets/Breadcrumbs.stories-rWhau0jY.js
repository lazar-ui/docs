import{H as e,R as C}from"./iframe-16V6KrfE.js";import{c as _}from"./clsx-B-dksMZM.js";import{i as R}from"./isValidReactNode-CUbPtuQj.js";import"./camelCase-Ct2evvX9.js";import"./preload-helper-PPVm8Dsz.js";const I="Breadcrumbs",N="/";var j=(a=>(a.ITEM=`${I}.Item`,a))(j||{});const P="_root_isif9_12",k="_list_isif9_16",S="_item_isif9_26",L="_link_isif9_32",A="_label_isif9_43",T="_current_isif9_49",v="_separator_isif9_54",t={root:P,list:k,item:S,link:L,label:A,current:T,separator:v},H=[j.ITEM],B=a=>{const{children:s,items:c,separator:u=N}=a;if(c){if(c.length===0)return null;const o=(n,m)=>{const y=m===c.length-1,x=n.current||y;let i;return n.href&&!x?i=e.jsx("a",{className:t.link,href:n.href,children:n.label}):x?i=e.jsx("span",{"aria-current":"page",className:_(t.label,t.current),children:n.label}):i=e.jsx("span",{className:t.label,children:n.label}),e.jsxs("li",{className:t.item,children:[i,!y&&e.jsx("span",{"aria-hidden":"true",className:t.separator,children:u})]},m)};return e.jsx("nav",{"aria-label":"breadcrumb",className:t.root,children:e.jsx("ol",{className:t.list,children:c.map((n,m)=>o(n,m))})})}const d=[];return C.Children.forEach(s,o=>{R(H,o)&&d.push(o)}),d.length===0?null:e.jsx("nav",{"aria-label":"breadcrumb",className:t.root,children:e.jsx("ol",{className:t.list,children:d.map((o,n)=>{const m=n===d.length-1;return e.jsxs("li",{className:t.item,children:[o,!m&&e.jsx("span",{"aria-hidden":"true",className:t.separator,children:u})]},n)})})})};B.displayName=I;B.__docgenInfo={description:`Breadcrumbs navigation component. Renders a trail of links indicating the current page location.
