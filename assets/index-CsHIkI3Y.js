import{N as g,H as o,R as v}from"./iframe-rByIh3n2.js";import{B as y}from"./Button-Ci06rhvs.js";import{C as w}from"./Chip-Cil2tH3j.js";import{u as x}from"./useLocale-D4JSor6x.js";import{c as C}from"./clsx-B-dksMZM.js";import{g as A}from"./getVariantClassName-DoOrEeQ5.js";import{i as c}from"./isValidReactNode-DkRv2iqy.js";import"./camelCase-j001MW_n.js";const R="Table.ActiveFilters",N="_root_4qb7d_5",L={root:N},u=e=>{const{filters:l,onClearAll:t,onRemove:a}=e,i=x(),n=g.useCallback(s=>()=>{a(s)},[a]),m=g.useCallback(()=>{t?.()},[t]);return l.length===0?null:o.jsxs("div",{className:L.root,children:[l.map(s=>o.jsxs(w,{onDelete:n(s.key),children:[s.label,": ",s.value]},s.key)),t&&o.jsx(y,{mode:"text",size:"sm",onClick:m,children:i.Table.ActiveFilters.clearAll})]})};u.displayName=R;u.__docgenInfo={description:`Table.ActiveFilters — displays active filter chips with individual remove buttons
