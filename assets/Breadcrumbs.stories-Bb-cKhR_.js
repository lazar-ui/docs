import{H as e,R as C}from"./iframe-Co-vi7Ap.js";import{c as _}from"./clsx-B-dksMZM.js";import{i as R}from"./isValidReactNode-ccyhQD_M.js";import"./camelCase-uFo-OJf_.js";import"./preload-helper-PPVm8Dsz.js";const I="Breadcrumbs",N="/";var j=(a=>(a.ITEM=`${I}.Item`,a))(j||{});const P="_root_w4o54_12",w="_list_w4o54_16",k="_item_w4o54_26",S="_link_w4o54_32",L="_label_w4o54_43",A="_current_w4o54_49",T="_separator_w4o54_54",t={root:P,list:w,item:k,link:S,label:L,current:A,separator:T},v=[j.ITEM],B=a=>{const{children:s,items:c,separator:u=N}=a;if(c){if(c.length===0)return null;const o=(n,m)=>{const g=m===c.length-1,x=n.current||g;let l;return n.href&&!x?l=e.jsx("a",{className:t.link,href:n.href,children:n.label}):x?l=e.jsx("span",{"aria-current":"page",className:_(t.label,t.current),children:n.label}):l=e.jsx("span",{className:t.label,children:n.label}),e.jsxs("li",{className:t.item,children:[l,!g&&e.jsx("span",{"aria-hidden":"true",className:t.separator,children:u})]},m)};return e.jsx("nav",{"aria-label":"breadcrumb",className:t.root,children:e.jsx("ol",{className:t.list,children:c.map((n,m)=>o(n,m))})})}const d=[];return C.Children.forEach(s,o=>{R(v,o)&&d.push(o)}),d.length===0?null:e.jsx("nav",{"aria-label":"breadcrumb",className:t.root,children:e.jsx("ol",{className:t.list,children:d.map((o,n)=>{const m=n===d.length-1;return e.jsxs("li",{className:t.item,children:[o,!m&&e.jsx("span",{"aria-hidden":"true",className:t.separator,children:u})]},n)})})})};B.displayName=I;B.__docgenInfo={description:`Breadcrumbs navigation component. Renders a trail of links indicating the current page location.
