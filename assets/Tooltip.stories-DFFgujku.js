import{N as o,H as e}from"./iframe-Dxm6wkCs.js";import{B as u}from"./Badge-CQ2SCls8.js";import{B as L}from"./Button-hs5znv8t.js";import{s as N}from"./Overlay-BC7rFpTg.js";import{$ as P}from"./useOverlayPosition-e8PGXBD1.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./getVariantClassName-Qnu0mv72.js";import"./camelCase-Df9BNvgk.js";import"./index-PRTEUu8a.js";import"./index-DT_Pa5O3.js";const w=o.createContext(null),O=w.Provider,R=()=>{const n=o.useContext(w);if(!n)throw new Error("Sub-component must be used within a Tooltip");return n},x="Tooltip",$=500,k=150,A=6;var C=(n=>(n.TRIGGER=`${x}.Trigger`,n.CONTENT=`${x}.Content`,n))(C||{});const M="_content_16k4n_11",H="_arrow_16k4n_26",j={content:M,arrow:H},b=n=>{const{children:d}=n,{cancelClose:m,close:l,contentId:a,isOpen:c,placement:T,triggerRef:s}=R(),i=o.useRef(null),{arrowProps:h,overlayProps:p,placement:r}=P({isOpen:c,offset:A,overlayRef:i,placement:T,shouldFlip:!0,targetRef:s});return c?e.jsx(N,{children:e.jsxs("div",{className:j.content,"data-placement":r,id:a,onMouseEnter:m,onMouseLeave:l,ref:i,role:"tooltip",...p,children:[e.jsx("div",{className:j.arrow,...h}),d]})}):null};b.displayName=C.CONTENT;b.__docgenInfo={description:"Tooltip content panel. Renders via portal with automatic positioning and arrow.\n\nMust be used as a child of `<Tooltip>`.",methods:[]};const v=n=>{const{children:d,placement:m="top",showDelay:l=$,hideDelay:a=k}=n,c=o.useRef(null),T=o.useId(),s=o.useRef(void 0),i=o.useRef(void 0),[h,p]=o.useState(!1),r=o.useCallback(()=>{s.current!==void 0&&(clearTimeout(s.current),s.current=void 0),i.current!==void 0&&(clearTimeout(i.current),i.current=void 0)},[]);o.useEffect(()=>()=>{r()},[r]);const B=o.useCallback(()=>{r(),s.current=window.setTimeout(()=>{p(!0)},l)},[r,l]),I=o.useCallback(()=>{r(),i.current=window.setTimeout(()=>{p(!1)},a)},[r,a]),_=o.useCallback(()=>{i.current!==void 0&&(clearTimeout(i.current),i.current=void 0)},[]),D=o.useCallback(()=>{r(),p(!0)},[r]),E=o.useCallback(()=>{r(),p(!1)},[r]);return e.jsx(O,{value:{cancelClose:_,close:I,closeImmediate:E,contentId:T,isOpen:h,open:B,openImmediate:D,placement:m,triggerRef:c},children:d})};v.displayName=x;v.__docgenInfo={description:`Tooltip container. Manages open/close state with show/hide delays and provides context
...
}`,...f.parameters?.docs?.source}}};const X=["Default","Placements"];export{g as Default,f as Placements,X as __namedExportsOrder,V as default};
