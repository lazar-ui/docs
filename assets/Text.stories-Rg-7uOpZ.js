import{R as j,H as t}from"./iframe-Clq7LvfQ.js";import{c as D}from"./clsx-B-dksMZM.js";import{g as x}from"./getVariantClassName-BFPka3Fn.js";import"./preload-helper-PPVm8Dsz.js";import"./camelCase-wp07HLyd.js";function k(e){const s=[];return e.underline&&s.push("underline"),e.underline==="dotted"&&s.push("dotted"),e.strikethrough&&s.push("line-through"),s.length>0?{textDecoration:s.join(" ")}:void 0}const L="Text",M="sm",W="normal",B="p",E="_root_1vl2j_1",R="_truncate_1vl2j_5",N="_sizeXs_1vl2j_12",U="_sizeSm_1vl2j_18",A="_sizeMd_1vl2j_24",q="_sizeLg_1vl2j_30",C="_weightNormal_1vl2j_37",V="_weightMedium_1vl2j_41",H="_weightSemibold_1vl2j_45",P="_weightBold_1vl2j_49",X="_colorPrimary_1vl2j_54",G="_colorSecondary_1vl2j_58",I="_colorTertiary_1vl2j_62",F="_colorDisabled_1vl2j_66",$="_colorBrand_1vl2j_70",o={root:E,truncate:R,sizeXs:N,sizeSm:U,sizeMd:A,sizeLg:q,weightNormal:C,weightMedium:V,weightSemibold:H,weightBold:P,colorPrimary:X,colorSecondary:G,colorTertiary:I,colorDisabled:F,colorBrand:$},r=j.forwardRef((e,s)=>{const{as:y=B,children:T,color:g,size:f=M,weight:b=W,truncate:v=!1,underline:_,strikethrough:w}=e,z=k({strikethrough:w,underline:_}),S=D(o.root,x("size",f,o),x("weight",b,o),g&&x("color",g,o),{[o.truncate]:v});return t.jsx(y,{className:S,ref:s,style:z,children:T})});r.displayName=L;r.__docgenInfo={description:`Text — component for displaying body text.
...
\`\`\``,methods:[],displayName:"Text",props:{as:{required:!1,tsType:{name:"union",raw:"'p' | 'span' | 'div'",elements:[{name:"literal",value:"'p'"},{name:"literal",value:"'span'"},{name:"literal",value:"'div'"}]},description:"HTML tag for rendering the root element. Defaults to `p`."},size:{required:!1,tsType:{name:"literal",value:"`${ETextSize}`"},description:"Text size. Defaults to `sm`."},weight:{required:!1,tsType:{name:"literal",value:"`${ETextWeight}`"},description:"Font weight. Defaults to `normal`."},color:{required:!1,tsType:{name:"literal",value:"`${ETextColor}`"},description:"Text color from the design system. If not provided — uses inherited color."},truncate:{required:!1,tsType:{name:"boolean"},description:"Truncate text with ellipsis (single line, `text-overflow: ellipsis`)."},underline:{required:!1,tsType:{name:"union",raw:"boolean | 'dotted'",elements:[{name:"boolean"},{name:"literal",value:"'dotted'"}]},description:"Underline: `true` for regular underline, `'dotted'` for dotted underline."},strikethrough:{required:!1,tsType:{name:"boolean"},description:"Strikethrough text (`text-decoration: line-through`)."},ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLElement>",elements:[{name:"HTMLElement"}]},description:"Ref on the root element."}}};const Q={title:"@lazar-ui／kit/Components/Text",component:r,parameters:{layout:"centered"},tags:["autodocs"],args:{children:"The quick brown fox jumps over the lazy dog",size:"sm",weight:"normal"},argTypes:{as:{control:{type:"select"},options:["p","span","div"],table:{defaultValue:{summary:"p"},type:{summary:"'p' | 'span' | 'div'"}}},size:{control:{type:"select"},options:["xs","sm","md","lg"],table:{defaultValue:{summary:"sm"},type:{summary:"'xs' | 'sm' | 'md' | 'lg'"}}},weight:{control:{type:"select"},options:["normal","medium","semibold","bold"],table:{defaultValue:{summary:"normal"},type:{summary:"'normal' | 'medium' | 'semibold' | 'bold'"}}},color:{control:{type:"select"},options:["primary","secondary","tertiary","disabled","brand"],table:{type:{summary:"'primary' | 'secondary' | 'tertiary' | 'disabled' | 'brand'"}}},truncate:{control:{type:"boolean"},table:{defaultValue:{summary:"false"}}},underline:{control:{type:"select"},options:[!0,"dotted"],table:{defaultValue:{summary:"false"},type:{summary:"boolean | 'dotted'"}}},strikethrough:{control:{type:"boolean"},table:{defaultValue:{summary:"false"}}},children:{control:{type:"text"},table:{type:{summary:"React.ReactNode"}}}}},h={},i={name:"Sizes",render:e=>t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[t.jsx(r,{...e,size:"lg",children:"Text LG (16px)"}),t.jsx(r,{...e,size:"md",children:"Text MD (15px)"}),t.jsx(r,{...e,size:"sm",children:"Text SM (14px)"}),t.jsx(r,{...e,size:"xs",children:"Text XS (12px)"})]})},a={name:"Weights",render:e=>t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[t.jsx(r,{...e,size:"md",weight:"normal",children:"Weight Normal (400)"}),t.jsx(r,{...e,size:"md",weight:"medium",children:"Weight Medium (500)"}),t.jsx(r,{...e,size:"md",weight:"semibold",children:"Weight Semibold (600)"}),t.jsx(r,{...e,size:"md",weight:"bold",children:"Weight Bold (700)"})]})},n={render:e=>t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[t.jsx(r,{...e,color:"primary",children:"Primary"}),t.jsx(r,{...e,color:"secondary",children:"Secondary"}),t.jsx(r,{...e,color:"tertiary",children:"Tertiary"}),t.jsx(r,{...e,color:"disabled",children:"Disabled"}),t.jsx(r,{...e,color:"brand",children:"Brand"})]})},l={args:{size:"sm",weight:"medium",children:"Label text (sm, medium weight)"}},d={args:{underline:!0}},c={args:{underline:"dotted"}},m={args:{strikethrough:!0}},p={args:{underline:!0,strikethrough:!0}},u={args:{truncate:!0,children:"This is a very long text that should be truncated to a single line with an ellipsis because it exceeds the available container width."},render:e=>t.jsx("div",{style:{width:280},children:t.jsx(r,{...e})})};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"{}",...h.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: 'Sizes',
