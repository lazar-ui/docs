import{H as e,R as w}from"./iframe-DLdpy6-y.js";import{c as _}from"./clsx-B-dksMZM.js";import{g as h}from"./getVariantClassName-DR0bhogv.js";import"./preload-helper-PPVm8Dsz.js";import"./camelCase-CqHBbmbu.js";const E="Textarea",j="_root_mvsip_14",R="_invalid_mvsip_55",C="_sizeSm_mvsip_67",L="_sizeMd_mvsip_73",B="_sizeLg_mvsip_79",M="_resizeNone_mvsip_86",D="_resizeVertical_mvsip_90",V="_resizeBoth_mvsip_94",s={root:j,invalid:R,sizeSm:C,sizeMd:L,sizeLg:B,resizeNone:M,resizeVertical:D,resizeBoth:V},a=t=>{const{invalid:r=!1,resize:u="vertical",rows:x=3,size:v="md",onChange:g,onBlur:y,onFocus:z,...T}=t,f=_(s.root,h("size",v,s),h("resize",u,s),r&&s.invalid),S=b=>{g?.(b.target.value)};return e.jsx("textarea",{...T,className:f,onChange:S,onBlur:y,onFocus:z,rows:x})};a.displayName=E;a.__docgenInfo={description:`Textarea component. Renders a native \`<textarea>\` with size, resize, and state variants.
