import{H as e,N as m}from"./iframe-BPBzskJH.js";import{c as L}from"./clsx-B-dksMZM.js";import{g as D}from"./getVariantClassName-CIxlLHOn.js";import{I as j}from"./Icon-CL_Nu61O.js";import{u as B}from"./useLocale-CeB-Jzga.js";import"./preload-helper-PPVm8Dsz.js";import"./camelCase-Dkfjdynd.js";const h={INPUT:"Input",INPUT_EMAIL:"InputEmail",INPUT_NUMBER:"InputNumber",INPUT_PASSWORD:"InputPassword",INPUT_PHONE:"InputPhone"},W="_root_r7jxc_17",H="_invalid_r7jxc_36",O="_disabled_r7jxc_42",U="_sizeSm_r7jxc_56",q="_sizeMd_r7jxc_60",A="_sizeLg_r7jxc_64",F="_control_r7jxc_68",$="_before_r7jxc_101",V="_after_r7jxc_102",K="_togglePassword_r7jxc_110",i={root:W,invalid:H,disabled:O,sizeSm:U,sizeMd:q,sizeLg:A,control:F,before:$,after:V,togglePassword:K},p=s=>{const{ref:r,invalid:t=!1,size:n="md",before:o,after:a,className:c,onChange:d,onBlur:u,onFocus:E,...f}=s,z=L(i.root,D("size",n,i),{[i.disabled]:f.disabled===!0,[i.invalid]:t},c),M=C=>{d?.(C.target.value)};return e.jsxs("div",{className:z,children:[o&&e.jsx("span",{className:i.before,children:o}),e.jsx("input",{ref:r,className:i.control,onChange:M,onBlur:u,onFocus:E,...f}),a&&e.jsx("span",{className:i.after,children:a})]})};p.displayName=h.INPUT;p.__docgenInfo={description:'Base Input component. Renders a native `<input>` with support for `before`/`after` slots, sizing, and invalid/disabled states.\nAll native `<input>` attributes are passed through automatically.\n\n@example\n```tsx\n<Input placeholder="Enter text" />\n<Input size="lg" invalid placeholder="Error" />\n<Input before={<SearchIcon />} placeholder="Search" />\n```',methods:[],displayName:"Input",props:{ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:""},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:""},before:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},after:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},onBlur:{required:!1,tsType:{name:"signature",type:"function",raw:"(e: React.FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"e"}],return:{name:"void"}}},description:""},onFocus:{required:!1,tsType:{name:"signature",type:"function",raw:"(e: React.FocusEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactFocusEvent",raw:"React.FocusEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"e"}],return:{name:"void"}}},description:""}},composes:["Omit"]};function Y(s){const r=s.replace(/\D/g,"").slice(0,11);if(!r)return"";let t="+7";return r.length>1&&(t+=` (${r.slice(1,4)}`),r.length>=4&&(t+=`) ${r.slice(4,7)}`),r.length>=7&&(t+=`-${r.slice(7,9)}`),r.length>=9&&(t+=`-${r.slice(9,11)}`),t}function G(s){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(s)}const T=s=>{const{ref:r,before:t,onBlur:n,invalid:o,...a}=s,[c,d]=m.useState(!1),u=m.useCallback(f=>{d(!0),n?.(f)},[n]),E=o||c&&a.value!=null&&!G(a.value);return e.jsx(p,{ref:r,type:"email",before:t??e.jsx(j,{name:"mail",size:16}),invalid:E,onBlur:u,...a})};T.displayName=h.INPUT_EMAIL;T.__docgenInfo={description:'Email Input variant. Renders `<Input type="email">` with an `@` icon `before` slot and built-in email validation on blur.\n\nValidation uses a regex check (`/^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/`) and sets `invalid` state if the value is non-empty and invalid after blur.\nConsumer can still pass `invalid` explicitly to force error state.\n\n@example\n```tsx\n<Input.Email placeholder="user@example.com" />\n```',methods:[],displayName:"InputEmail",composes:["Omit"]};const k=s=>{const{ref:r,...t}=s;return e.jsx(p,{ref:r,type:"number",inputMode:"numeric",...t})};k.displayName=h.INPUT_NUMBER;k.__docgenInfo={description:'Number Input variant. Renders `<Input type="number">` with `inputMode="numeric"`, hideable native spinner, and optional `min`/`max`/`step`.\n\n@example\n```tsx\n<Input.Number placeholder="0" />\n<Input.Number min={0} max={100} step={5} />\n```',methods:[],displayName:"InputNumber",props:{min:{required:!1,tsType:{name:"number"},description:""},max:{required:!1,tsType:{name:"number"},description:""},step:{required:!1,tsType:{name:"number"},description:""}},composes:["Omit"]};const R=s=>{const{ref:r,after:t,...n}=s,o=B(),[a,c]=m.useState(!1),d=m.useCallback(()=>c(u=>!u),[]);return e.jsx(p,{ref:r,type:a?"text":"password",after:t??e.jsx("button",{type:"button",className:i.togglePassword,onClick:d,tabIndex:-1,"aria-label":a?o.input.passwordHide:o.input.passwordShow,children:a?e.jsx(j,{name:"eyeOff",size:16}):e.jsx(j,{name:"eye",size:16})}),...n})};R.displayName=h.INPUT_PASSWORD;R.__docgenInfo={description:'Password Input variant. Renders an input with a built-in eye toggle in the `after` slot to show/hide the password.\n\nToggles between `type="password"` and `type="text"` on click. Consumer can override the default eye toggle by passing a custom `after`.\n\n@example\n```tsx\n<Input.Password placeholder="Password" />\n```',methods:[],displayName:"InputPassword",composes:["Omit"]};const S=s=>{const{ref:r,before:t,onChange:n,...o}=s,a=m.useCallback(c=>{const d=Y(c);n?.(d)},[n]);return e.jsx(p,{ref:r,type:"tel",before:t??e.jsx(j,{name:"phone",size:16}),onChange:a,...o})};S.displayName=h.INPUT_PHONE;S.__docgenInfo={description:'Phone Input variant. Renders `<Input type="tel">` with a phone icon `before` slot and automatic masking in `+7 (999) 999-99-99` format.\n\nThe mask is applied on every change via `applyMask()`. Consumer can override the default icon by passing a custom `before`.\n\n@example\n```tsx\n<Input.Phone placeholder="+7 (999) 999-99-99" />\n```',methods:[],displayName:"InputPhone",composes:["Omit"]};const l=Object.assign(p,{Email:T,Number:k,Password:R,Phone:S}),te={title:"Kit/Components/Input",component:l,parameters:{layout:"centered"},tags:["autodocs"],args:{placeholder:"Placeholder",size:"md"}},g={},x={render:s=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12,width:280},children:[e.jsx(l,{...s,size:"sm",placeholder:"Small"}),e.jsx(l,{...s,size:"md",placeholder:"Medium"}),e.jsx(l,{...s,size:"lg",placeholder:"Large"})]})},v={args:{invalid:!0,placeholder:"Error state"}},y={args:{disabled:!0,placeholder:"Disabled"}},I={args:{before:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",children:[e.jsx("circle",{cx:"8",cy:"8",r:"6",stroke:"currentColor",strokeWidth:"1.5",fill:"none"}),e.jsx("path",{d:"M8 4v4l2 2",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})]}),placeholder:"With before icon"}},b={args:{after:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M6 12l4-4-4-4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),placeholder:"With after icon"}},w={render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,width:280},children:e.jsx(l.Password,{placeholder:"Password"})})},N={render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,width:280},children:e.jsx(l.Phone,{placeholder:"+7 (999) 999-99-99"})})},_={render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,width:280},children:e.jsx(l.Email,{placeholder:"user@example.com"})})},P={render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,width:280},children:e.jsx(l.Number,{placeholder:"Number"})})};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:"{}",...g.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
...
}`,...P.parameters?.docs?.source}}};const ae=["Default","Sizes","Invalid","Disabled","WithBefore","WithAfter","Password","Phone","Email","Number"];export{g as Default,y as Disabled,_ as Email,v as Invalid,P as Number,w as Password,N as Phone,x as Sizes,b as WithAfter,I as WithBefore,ae as __namedExportsOrder,te as default};
