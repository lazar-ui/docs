import{N as n,H as o}from"./iframe-vKSYs7iX.js";import{c as w}from"./clsx-B-dksMZM.js";import{I as j}from"./Icon-wH_OFNsQ.js";import"./preload-helper-PPVm8Dsz.js";const k="DropZone",N="_root_1a373_2",b="_dragOver_1a373_25",Z="_hiddenInput_1a373_31",g={root:N,dragOver:b,hiddenInput:Z},t=e=>{const{accept:l,children:f,onFileSelect:s}=e,[m,h]=n.useState(!1),i=n.useRef(null),D=n.useCallback(r=>{r.preventDefault(),r.stopPropagation(),h(!0)},[]),v=n.useCallback(r=>{r.preventDefault(),r.stopPropagation(),h(!1)},[]),x=n.useCallback(r=>{r.preventDefault(),r.stopPropagation(),h(!1);const a=r.dataTransfer.files[0];a&&s(a)},[s]),S=n.useCallback(()=>{i.current?.click()},[]),F=n.useCallback(r=>{const a=r.target.files?.[0];a&&(s(a),i.current&&(i.current.value=""))},[s]),y=w(g.root,{[g.dragOver]:m});return o.jsxs("div",{className:y,"data-testid":"drop-zone",onClick:S,onDragLeave:v,onDragOver:D,onDrop:x,role:"button",tabIndex:0,children:[f,o.jsx("input",{accept:l,className:g.hiddenInput,onChange:F,ref:i,type:"file"})]})};t.displayName=k;t.__docgenInfo={description:`DropZone component. Renders a drag-and-drop area for file uploads.
