import{H as e}from"./iframe-__PV-dJp.js";import{c as m}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";const v="Separator",u="_root_kvseh_5",x="_vertical_kvseh_14",y="_bleed_kvseh_21",n={root:u,vertical:x,bleed:y},r=i=>{const{vertical:d=!1,color:l,bleed:c=!1}=i,p=m(n.root,d&&n.vertical,c&&n.bleed);return e.jsx("hr",{className:p,style:{"--separator-color":l??"var(--lui-color-border-primary)"}})};r.displayName=v;r.__docgenInfo={description:`Separator component. Renders a horizontal or vertical dividing line.
