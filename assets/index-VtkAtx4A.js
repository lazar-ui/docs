import{N as g,H as o,R as v}from"./iframe-CU9UgNWq.js";import{B as y}from"./Button-CeegfEl2.js";import{C as w}from"./Chip-cnwON9TO.js";import{u as x}from"./useLocale-9DCUdBZq.js";import{c as C}from"./clsx-B-dksMZM.js";import{g as A}from"./getVariantClassName-CJ3-95sG.js";import{i as c}from"./isValidReactNode-_QqXq388.js";import"./camelCase-DBDeD0gf.js";const R="Table.ActiveFilters",N="_root_4qb7d_5",L={root:N},u=e=>{const{filters:l,onClearAll:t,onRemove:a}=e,i=x(),n=g.useCallback(s=>()=>{a(s)},[a]),m=g.useCallback(()=>{t?.()},[t]);return l.length===0?null:o.jsxs("div",{className:L.root,children:[l.map(s=>o.jsxs(w,{onDelete:n(s.key),children:[s.label,": ",s.value]},s.key)),t&&o.jsx(y,{mode:"text",size:"sm",onClick:m,children:i.Table.ActiveFilters.clearAll})]})};u.displayName=R;u.__docgenInfo={description:`Table.ActiveFilters — displays active filter chips with individual remove buttons
