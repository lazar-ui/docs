import{H as e,R as w}from"./iframe-n4ZyvbqO.js";import{c as _}from"./clsx-B-dksMZM.js";import{g as v}from"./getVariantClassName-CW3tvtKI.js";import"./preload-helper-PPVm8Dsz.js";import"./camelCase-CAJeNIN1.js";const E="Textarea",j="_root_vl3vx_14",R="_invalid_vl3vx_55",C="_sizeSm_vl3vx_67",L="_sizeMd_vl3vx_73",B="_sizeLg_vl3vx_79",M="_resizeNone_vl3vx_86",D="_resizeVertical_vl3vx_90",V="_resizeBoth_vl3vx_94",s={root:j,invalid:R,sizeSm:C,sizeMd:L,sizeLg:B,resizeNone:M,resizeVertical:D,resizeBoth:V},a=t=>{const{invalid:r=!1,resize:x="vertical",rows:u=3,size:h="md",onChange:g,onBlur:y,onFocus:z,...T}=t,f=_(s.root,v("size",h,s),v("resize",x,s),r&&s.invalid),S=b=>{g?.(b.target.value)};return e.jsx("textarea",{...T,className:f,onChange:S,onBlur:y,onFocus:z,rows:u})};a.displayName=E;a.__docgenInfo={description:`Textarea component. Renders a native \`<textarea>\` with size, resize, and state variants.
