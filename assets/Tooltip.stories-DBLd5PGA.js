import{N as o,H as e}from"./iframe-16V6KrfE.js";import{B as u}from"./Badge-CCGxd2jH.js";import{B as L}from"./Button-L2Grj_6q.js";import{s as N}from"./Overlay-B8WTMqXI.js";import{$ as P}from"./useOverlayPosition-C7kY86Ux.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./getVariantClassName-BE0gBw9M.js";import"./camelCase-Ct2evvX9.js";import"./Icon-doosmcXP.js";import"./index-1Rc3ySHy.js";import"./index-JMs-wM20.js";const w=o.createContext(null),O=w.Provider,R=()=>{const n=o.useContext(w);if(!n)throw new Error("Sub-component must be used within a Tooltip");return n},x="Tooltip",$=500,A=150,M=6;var C=(n=>(n.TRIGGER=`${x}.Trigger`,n.CONTENT=`${x}.Content`,n))(C||{});const k="_content_gj50m_11",H="_arrow_gj50m_26",j={content:k,arrow:H},b=n=>{const{children:d}=n,{cancelClose:m,close:l,contentId:a,isOpen:c,placement:T,triggerRef:s}=R(),i=o.useRef(null),{arrowProps:h,overlayProps:p,placement:r}=P({isOpen:c,offset:M,overlayRef:i,placement:T,shouldFlip:!0,targetRef:s});return c?e.jsx(N,{children:e.jsxs("div",{className:j.content,"data-placement":r,id:a,onMouseEnter:m,onMouseLeave:l,ref:i,role:"tooltip",...p,children:[e.jsx("div",{className:j.arrow,...h}),d]})}):null};b.displayName=C.CONTENT;b.__docgenInfo={description:"Tooltip content panel. Renders via portal with automatic positioning and arrow.\n\nMust be used as a child of `<Tooltip>`.",methods:[]};const v=n=>{const{children:d,placement:m="top",showDelay:l=$,hideDelay:a=A}=n,c=o.useRef(null),T=o.useId(),s=o.useRef(void 0),i=o.useRef(void 0),[h,p]=o.useState(!1),r=o.useCallback(()=>{s.current!==void 0&&(clearTimeout(s.current),s.current=void 0),i.current!==void 0&&(clearTimeout(i.current),i.current=void 0)},[]);o.useEffect(()=>()=>{r()},[r]);const B=o.useCallback(()=>{r(),s.current=window.setTimeout(()=>{p(!0)},l)},[r,l]),I=o.useCallback(()=>{r(),i.current=window.setTimeout(()=>{p(!1)},a)},[r,a]),_=o.useCallback(()=>{i.current!==void 0&&(clearTimeout(i.current),i.current=void 0)},[]),D=o.useCallback(()=>{r(),p(!0)},[r]),E=o.useCallback(()=>{r(),p(!1)},[r]);return e.jsx(O,{value:{cancelClose:_,close:I,closeImmediate:E,contentId:T,isOpen:h,open:B,openImmediate:D,placement:m,triggerRef:c},children:d})};v.displayName=x;v.__docgenInfo={description:`Tooltip container. Manages open/close state with show/hide delays and provides context
