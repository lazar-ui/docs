...
\`\`\``,methods:[]};const ae="Drawer",se=[i.ACTIONS,i.CONTENT,i.HEADER],A=o.createContext(null),oe=()=>{const t=o.useContext(A);if(!t)throw new Error("Drawer sub-components must be used within a Drawer component.");return t},ie="_underlay_kqtqc_24",le="_modal_kqtqc_32",ce="_drawer_kqtqc_37",pe="_placementLeft_kqtqc_47",de="_entered_kqtqc_53",me="_placementRight_kqtqc_56",ue="_placementTop_kqtqc_65",he="_placementBottom_kqtqc_74",we="_sizeSm_kqtqc_83",fe="_sizeMd_kqtqc_90",De="_sizeLg_kqtqc_97",Ce="_content_kqtqc_105",d={underlay:ie,modal:le,drawer:ce,placementLeft:pe,entered:de,placementRight:me,placementTop:ue,placementBottom:he,sizeSm:we,sizeMd:fe,sizeLg:De,content:Ce},xe=300,j=t=>{const{children:a,container:s,dismissable:n=!0,onOpenChange:l,open:c,placement:C="right",size:B="md"}=t,k=o.useRef(null),x=o.useRef(null),{dialogProps:z}=U(t,k),N=J({isOpen:c,onOpenChange:l}),{modalProps:E,underlayProps:$}=W({isDismissable:n,isKeyboardDismissDisabled:!1},N,x),[S,H]=o.useState(c||!1),[I,q]=o.useState(!1),g=o.useRef(S);o.useEffect(()=>{if(c){g.current=!0,H(!0);const y=requestAnimationFrame(()=>{requestAnimationFrame(()=>{q(!0)})});return()=>cancelAnimationFrame(y)}if(g.current){q(!1);const y=setTimeout(()=>{g.current=!1,H(!1)},xe);return()=>clearTimeout(y)}},[c]);const{[i.ACTIONS]:L,[i.CONTENT]:v,[i.HEADER]:M}=o.useMemo(()=>Q(a,se),[a]),P=Y(d.drawer,R("size",B,d),R("placement",C,d),{[d.entered]:I});return S?e.jsx(K,{portalContainer:s,children:e.jsx("div",{className:d.underlay,...$,children:e.jsx("div",{className:d.modal,...E,ref:x,children:e.jsx(G,{getContainer:()=>x.current,children:e.jsx(A.Provider,{value:{close:()=>N.close()},children:e.jsxs("div",{"aria-label":"Drawer","aria-modal":"true",className:P,role:"dialog",...z,ref:k,children:[M,v&&e.jsx("div",{className:d.content,children:v}),L]})})})})})}):null};j.displayName=ae;j.__docgenInfo={description:`Drawer component.
...
}`,...D.parameters?.docs?.source}}};const Le=["Default","LeftPlacement","TopPlacement","Small","NonDismissable","WithActions"];export{m as Default,u as LeftPlacement,f as NonDismissable,w as Small,h as TopPlacement,D as WithActions,Le as __namedExportsOrder,Ie as default};
